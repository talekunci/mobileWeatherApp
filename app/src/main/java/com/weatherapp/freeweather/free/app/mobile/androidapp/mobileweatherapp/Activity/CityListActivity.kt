...
import com.weatherapp.freeweather.free.app.mobile.androidapp.mobileweatherapp.Adapter.CityAdapter
...
import com.weatherapp.freeweather.free.app.mobile.androidapp.mobileweatherapp.ViewModel.CityViewModel
import com.weatherapp.freeweather.free.app.mobile.androidapp.mobileweatherapp.databinding.ActivityCityListBinding
        ...
        binding.apply {
            cityEdit.addTextChangedListener(object : TextWatcher {
                ...
                override fun afterTextChanged(s: Editable?) {
                    cityListProgressBar.visibility = View.VISIBLE
                        ...
                        .enqueue(object : Callback<CityResponseApi> {
                            override fun onResponse(
                                ...
                                if (response.isSuccessful) {
                                    ...
                                    data?.let {
                                        cityListProgressBar.visibility = View.GONE
